...
function CategoriesTableMaterialInOut() {
                                            ...
                                            {data?.map((row, index) => (
                                                totalRows !== 0 ?
                                                    ...
                                                    >
                                                        ...
                                                        <TableCell align="right" ><div className=''><button className='editCategoryBtn mr-6' onClick={() => handleEdit(row.stockInCategoryId, row.stockInCategoryName)}>Edit</button></div></TableCell>
                                                ...
                                                {categoryStockOut?.map((row, index) => (
                                                    totalRowsStockOut !== 0 ?
                                                        ...
                                                        >
                                                            ...
                                                            <TableCell align="right" ><div className=''><button className='editCategoryBtn mr-6' onClick={() => handleEditStockOut(row.stockOutCategoryId, row.stockOutCategoryName)}>Edit</button></div></TableCell>
                                                            <TableCell align="right">
                                                            </TableCell>
                                                        </TableRow> :
                                                        <TableRow
...
export default CategoriesTableMaterialInOut;