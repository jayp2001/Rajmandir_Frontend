...
function MaterialTableByDepartmentInOut() {
    const regex = /^\d*(?:\.\d*)?$/;
                                                ...
                                                {categoryStockOut?.map((row, index) => (
                                                    totalRowsStockOut !== 0 ?
                                                        ...
                                                        >
                                                            ...
                                                            <TableCell align="right" ><div className=''><button className='editCategoryBtn mr-6' onClick={() => handleEditExpense(row)}>Edit</button></div></TableCell>
                                                            <TableCell align="right">
                                                            </TableCell>
                                                        </TableRow> :
                                                        <TableRow
...
export default MaterialTableByDepartmentInOut;