...
function AddFactorySupplierInOut() {
    ...
    const addSuppiler = async () => {
        setLoading(true);
        await axios.post(`${BACKEND_BASE_URL}rawMaterialrouter/addFactorySupplierDetails`, formData, config)
            .then((res) => {
                setLoading(false);
                setSuccess(true);
                focus();
...
export default AddFactorySupplierInOut;