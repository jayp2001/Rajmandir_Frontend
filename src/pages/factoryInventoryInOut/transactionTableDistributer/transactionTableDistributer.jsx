import './transactionTableDistributer.css';
...
function TransactionTableDistributerInOut() {
    ...
    const getDebitData = async () => {
        await axios.get(`${BACKEND_BASE_URL}mfProductrouter/getdistributorDebitTransactionList?&page=${1}&numPerPage=${rowsPerPage}`, config)
            .then((res) => {
    ...
    const getDebitDataOnPageChange = async (pageNum, rowPerPageNum) => {
        await axios.get(`${BACKEND_BASE_URL}mfProductrouter/getdistributorDebitTransactionList?page=${pageNum}&numPerPage=${rowPerPageNum}&searchInvoiceNumber=${searchWord}`, config)
            .then((res) => {
                setDebitTransaction(res.data.rows);
                setTotalRows(res.data.numRows);
            })
    ...
    const getDebitDataOnPageChangeByFilter = async (pageNum, rowPerPageNum) => {
        await axios.get(`${BACKEND_BASE_URL}mfProductrouter/getdistributorDebitTransactionList?startDate=${state[0].startDate}&endDate=${state[0].endDate}&page=${pageNum}&numPerPage=${rowPerPageNum}`, config)
            .then((res) => {
                setDebitTransaction(res.data.rows);
                setTotalRows(res.data.numRows);
            })
    ...
    const getDebitDataByFilter = async () => {
        await axios.get(`${BACKEND_BASE_URL}mfProductrouter/getdistributorDebitTransactionList?startDate=${state[0].startDate}&endDate=${state[0].endDate}&page=${1}&numPerPage=${rowsPerPage}`, config)
            .then((res) => {
                setDebitTransaction(res.data.rows);
                setTotalRows(res.data.numRows);
            })
    ...
    const getCashDataByFilter = async () => {
        await axios.get(`${BACKEND_BASE_URL}mfProductrouter/getDistributorCashAndDebit?startDate=${state[0].startDate}&endDate=${state[0].endDate}&page=${1}&numPerPage=${rowsPerPage}&payType=cash`, config)
            .then((res) => {
    ...
    const getCashData = async () => {
        await axios.get(`${BACKEND_BASE_URL}mfProductrouter/getDistributorCashAndDebit?&page=${page + 1}&numPerPage=${rowsPerPage}&payType=cash`, config)
            .then((res) => {
                setCashTransaction(res.data.rows);
                setTotalRowsCash(res.data.numRows);
            })
    ...
    const getDebit = async () => {
        await axios.get(`${BACKEND_BASE_URL}mfProductrouter/getDistributorCashAndDebit?&page=${page + 1}&numPerPage=${rowsPerPage}&payType=debit`, config)
            .then((res) => {
    ...
    const getDebitByFilter = async () => {
        await axios.get(`${BACKEND_BASE_URL}mfProductrouter/getDistributorCashAndDebit?startDate=${state[0].startDate}&endDate=${state[0].endDate}&page=${1}&numPerPage=${rowsPerPage}&payType=debit`, config)
            .then((res) => {
                setDebitData(res.data.rows);
                setTotalRowsDebit(res.data.numRows);
            })
    ...
    const getCashCounts = async () => {
        await axios.get(`${BACKEND_BASE_URL}mfProductrouter/getDistributorCashTransactionCounter?`, config)
            .then((res) => {
    ...
    const getCashCountsByFilter = async () => {
        await axios.get(`${BACKEND_BASE_URL}mfProductrouter/getDistributorCashTransactionCounter?startDate=${state[0].startDate}&endDate=${state[0].endDate}`, config)
            .then((res) => {
                setCashCount(res.data);
            })
            .catch((error) => {
    ...
    const getDebitCountsByFilter = async () => {
        await axios.get(`${BACKEND_BASE_URL}mfProductrouter/getDistributorDebitTransactionCounter?startDate=${state[0].startDate}&endDate=${state[0].endDate}`, config)
            .then((res) => {
                setDebitCount(res.data);
            })
            .catch((error) => {
    ...
    const getCashDataOnPageChange = async (pageNum, rowPerPageNum) => {
        await axios.get(`${BACKEND_BASE_URL}mfProductrouter/getDistributorCashAndDebit?page=${pageNum}&numPerPage=${rowPerPageNum}&payType=cash`, config)
            .then((res) => {
                setCashTransaction(res.data.rows);
                setTotalRowsCash(res.data.numRows);
            })
    ...
    const getDebitOnPageChange = async (pageNum, rowPerPageNum) => {
        await axios.get(`${BACKEND_BASE_URL}mfProductrouter/getDistributorCashAndDebit?page=${pageNum}&numPerPage=${rowPerPageNum}&payType=debit`, config)
            .then((res) => {
                setDebitData(res.data.rows);
                setTotalRowsDebit(res.data.numRows);
            })
    ...
    const getCashDataOnPageChangeByFilter = async (pageNum, rowPerPageNum) => {
        await axios.get(`${BACKEND_BASE_URL}mfProductrouter/getDistributorCashAndDebit?startDate=${state[0].startDate}&endDate=${state[0].endDate}&page=${pageNum}&numPerPage=${rowPerPageNum}&payType=cash`, config)
            .then((res) => {
                setCashTransaction(res.data.rows);
                setTotalRowsCash(res.data.numRows);
            })
    ...
    const getDebitOnPageChangeByFilter = async (pageNum, rowPerPageNum) => {
        await axios.get(`${BACKEND_BASE_URL}mfProductrouter/getDistributorCashAndDebit?startDate=${state[0].startDate}&endDate=${state[0].endDate}&page=${pageNum}&numPerPage=${rowPerPageNum}&payType=debit`, config)
            .then((res) => {
                setDebitData(res.data.rows);
                setTotalRowsDebit(res.data.numRows);
            })
    ...
    const debitExportExcel = async () => {
        if (window.confirm('Are you sure you want to export Excel ... ?')) {
            await axios({
                url: filter ? `${BACKEND_BASE_URL}mfProductrouter/exportExcelSheetForRmDebitTransactionList?startDate=${state[0].startDate}&endDate=${state[0].endDate}` : `${BACKEND_BASE_URL}mfProductrouter/exportExcelSheetForRmDebitTransactionList?startDate=${''}&endDate=${''}`,
                method: 'GET',
    ...
    const CashExportExcel = async () => {
        if (window.confirm('Are you sure you want to export Excel ... ?')) {
            await axios({
                url: filter ? `${BACKEND_BASE_URL}mfProductrouter/exportExcelSheetForRmCashTransactionList?startDate=${state[0].startDate}&endDate=${state[0].endDate}` : `${BACKEND_BASE_URL}mfProductrouter/exportExcelSheetForRmCashTransactionList?startDate=${''}&endDate=${''}`,
                method: 'GET',
                headers: { Authorization: `Bearer ${userInfo.token}` },
                responseType: 'blob', // important
            }).then((response) => {
    ...
    const DebitDataExportExcel = async () => {
        if (window.confirm('Are you sure you want to export Excel ... ?')) {
            await axios({
                url: filter ? `${BACKEND_BASE_URL}mfProductrouter/exportExcelSheetForRmDeditTransaction?startDate=${state[0].startDate}&endDate=${state[0].endDate}` : `${BACKEND_BASE_URL}mfProductrouter/exportExcelSheetForRmDeditTransaction?startDate=${''}&endDate=${''}`,
                method: 'GET',
                headers: { Authorization: `Bearer ${userInfo.token}` },
                responseType: 'blob', // important
            }).then((response) => {
    ...
    const deleteData = async (id) => {
        await axios.delete(`${BACKEND_BASE_URL}mfProductrouter/removeFactorySupplierTransactionDetails?distributorTransactionId=${id}`, config)
            .then((res) => {
                setSuccess(true)
            })
            .catch((error) => {
    ...
    const search = async (searchWord) => {
        await axios.get(`${BACKEND_BASE_URL}mfProductrouter/getdistributorDebitTransactionList?&page=${page + 1}&numPerPage=${rowsPerPage}&searchInvoiceNumber=${searchWord}`, config)
            .then((res) => {
                setDebitTransaction(res.data.rows);
                setTotalRows(res.data.numRows);
            })
    ...
    return (
        <div className='productListContainer'>
                            ...
                            <div className='h-full mobile:col-span-10  tablet1:col-span-10  tablet:col-span-7  laptop:col-span-7  desktop1:col-span-7  desktop2:col-span-7  desktop2:col-span-7 '>
                                <div className='grid grid-cols-12 pl-6 gap-3 h-full'>
                                    ...
                                    <div className={`flex col-span-3 justify-center ${tab === 2 || tab === '2' ? 'productTabAll' : 'productTab'}`}
                                        onClick={() => {
                                            setTab(2); setSearchWord(''); setPage(0); setRowsPerPage(5); setDebitTransaction([]); filter ? getDebitDataByFilter() : getDebitData(); filter ? getDebitCountsByFilter() : getDebitCounts();
                                        }}>
                                    ...
                                    <div className={`flex col-span-3 justify-center ${tab === 3 || tab === '3' ? 'productTabIn' : 'productTab'}`} onClick={() => {
                                        setTab(3); setSearchWord(''); setPage(0); setRowsPerPage(5); setCashTransaction([]); filter ? getCashDataByFilter() : getCashData(); filter ? getCashCountsByFilter() : getCashCounts();
                                    }}>
                                    ...
                                    <div className={`flex col-span-3 justify-center ${tab === 4 || tab === '4' ? 'productTabOut' : 'productTab'}`} onClick={() => {
                                        setTab(4); setSearchWord(''); setPage(0); setRowsPerPage(5); setDebitData([]); filter ? getDebitByFilter() : getDebit(); filter ? getDebitCountsByFilter() : getDebitCounts();
                                    }}>
            ...
            {tab === 2 || tab === '2' ?
                ...
                // : tab === 3 || tab === '3' ?
                //     <div className='mt-6 grid grid-cols-4 gap-6'>
                //         <CountCard color={'blue'} count={cashCount && cashCount.totalExpense ? cashCount.totalExpense : 0} desc={'Total Sold'} unitDesc={0} />
                ...
                //     </div> :
                //     <div className='mt-6 grid grid-cols-4 gap-6'>
                //         <CountCard color={'blue'} count={debitCount && debitCount.totalSell ? debitCount.totalSell : 0} desc={'Total Expense'} unitDesc={0} />
                //         <CountCard color={'green'} count={debitCount && debitCount.totalSellOfDebit ? debitCount.totalSellOfDebit : 0} desc={'Total Debit'} unitDesc={0} />
                //     </div>
                    ...
                    <div className='userTableSubContainer'>
                        <div className='grid grid-cols-12 pt-6'>
                            ...
                            <div className='col-span-6 col-start-7 pr-5 flex justify-end'>
                                <button className='exportExcelBtn' onClick={() => { tab === 2 || tab === '2' ? debitExportExcel() : tab === 3 || tab === '3' ? CashExportExcel() : DebitDataExportExcel() }}><FileDownloadIcon />&nbsp;&nbsp;Export Excel</button>
                            </div>
                        </div>
                        {tab === 2 || tab === '2' ?
                                    ...
                                    <Table sx={{ minWidth: 650 }} stickyHeader aria-label="sticky table">
                                        <TableHead>
                                            <TableRow>
                                                ...
                                                <TableCell align="left">Distributor Name</TableCell>
                                                <TableCell align="left">Paid By</TableCell>
                                                <TableCell align="right">Pending Amount</TableCell>
                                                <TableCell align="right">Recived Amount</TableCell>
                                        ...
                                        <TableBody>
                                            {debitTransaction?.map((row, index) => (
                                                totalRows !== 0 ?
                                                    <TableRow
                                                        hover
                                                        key={row.distributorTransactionId}
                                                    ...
                                                    >
                                                        ...
                                                        <TableCell align="left" >{row.distributorNickName}</TableCell>
                                                        ...
                                                        <TableCell align="right">
                                                            <Menutemp transactionId={row.distributorTransactionId} getInvoice={getInvoice} data={row} deleteTransaction={handleDeleteTransaction} />
                                                        </TableCell>
                                                    </TableRow> :
                                                    <TableRow
                                                        key={row.userId}
                                                ...
                                                {cashTransaction?.map((row, index) => (
                                                    totalRowsCash !== 0 ?
                                                        ...
                                                        >
                                                            ...
                                                            <TableCell align="left" >{parseFloat(row.sellAmount ? row.sellAmount : 0).toLocaleString('en-IN')}</TableCell>
                                                            <TableCell align="left" >{row.sellDate}</TableCell>
                                                            <TableCell align="left" >{row.sellTime}</TableCell>
                                        ...
                                        <Table sx={{ minWidth: 650 }} aria-label="simple table">
                                            <TableHead>
                                                <TableRow>
                                                    ...
                                                    <TableCell align="left">Sold Amount</TableCell>
                                                    <TableCell align="left">Date</TableCell>
                                                    <TableCell align="left">Time</TableCell>
                                                    {/* <TableCell align="left">stockOutDate</TableCell> */}
                                                </TableRow>
                                                ...
                                                {debitData?.map((row, index) => (
                                                    totalRowsDebit !== 0 ?
                                                        ...
                                                        >
                                                            ...
                                                            <TableCell align="left" >{row.enteredBy}</TableCell>
                                                            <TableCell align="left" >{parseFloat(row.sellAmount ? row.sellAmount : 0).toLocaleString('en-IN')}</TableCell>
                                                            <TableCell align="left" >{row.sellDate}</TableCell>
                                                            <TableCell align="left" >{row.sellTime}</TableCell>
                                                            {/* <TableCell align="left" >{row.stockOutDate}</TableCell> */}
...
export default TransactionTableDistributerInOut;
