...
function StockOutByCategoryMaterialInOut() {
    ...
    const getStockOutDataOnPageChange = async (pageNum, rowPerPageNum) => {
        await axios.get(`${BACKEND_BASE_URL}rawMaterialrouter/getRmStockOutDataByCategory?page=${pageNum}&numPerPage=${rowPerPageNum}&categoryId=${categoryId}`, config)
            .then((res) => {
    ...
    const getStockOutDataOnPageChangeByFilter = async (pageNum, rowPerPageNum) => {
        await axios.get(`${BACKEND_BASE_URL}rawMaterialrouter/getRmStockOutDataByCategory?startDate=${state[0].startDate}&endDate=${state[0].endDate}&page=${pageNum}&numPerPage=${rowPerPageNum}&categoryId=${categoryId}`, config)
            .then((res) => {
                setStockOutData(res.data.rows);
                setTotalRowsOut(res.data.numRows);
                setTotalStockOutPrice(res.data.totalStockOutPrice)
    ...
    const getStockOutData = async () => {
        await axios.get(`${BACKEND_BASE_URL}rawMaterialrouter/getRmStockOutDataByCategory?page=${page + 1}&numPerPage=${rowsPerPage}&categoryId=${categoryId}`, config)
            .then((res) => {
                setStockOutData(res.data.rows);
                setTotalRowsOut(res.data.numRows);
                setTotalStockOutPrice(res.data.totalStockOutPrice)
    ...
    const getStockOutDataByFilter = async () => {
        await axios.get(`${BACKEND_BASE_URL}rawMaterialrouter/getRmStockOutDataByCategory?startDate=${state[0].startDate}&endDate=${state[0].endDate}&page=${1}&numPerPage=${rowsPerPage}&categoryId=${categoryId}`, config)
            .then((res) => {
                setStockOutData(res.data.rows);
                setTotalRowsOut(res.data.numRows);
                setTotalStockOutPrice(res.data.totalStockOutPrice)
...
export default StockOutByCategoryMaterialInOut;