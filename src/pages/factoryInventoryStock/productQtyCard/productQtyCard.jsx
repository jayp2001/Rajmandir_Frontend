        ...
        <div className='productQtyCountcard flex gap-4' key={props.index}>
            ...
            <div className='self-center countWwrpProduct'>
                ...
                <div className='countTextProduct flex justify-between'>
                    <div className='text-ellipsis overflow-hidden qtyP'>{props.rawMaterialQty}</div><div className='text-ellipsis overflow-hidden priceP'><CurrencyRupeeIcon /> {parseFloat(props.productPrice ? props.productPrice : 0).toLocaleString('en-IN')}</div>
                </div>
                {/* </Tooltip> */}
            </div>
        </div >
