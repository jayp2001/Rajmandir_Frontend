import './supplierDetailOwner.css';
...
import CountCard from '../transaction/countCard/countCard';
...
function SupplierDetailOwner() {
    ...
    const getStatistics = async () => {
        await axios.get(`${BACKEND_BASE_URL}inventoryrouter/getOwnerSupplierCounterDetailsById?supplierId=${id}`, config)
            .then((res) => {
    ...
    const getStockInData = async () => {
        await axios.get(`${BACKEND_BASE_URL}inventoryrouter/getOwnerStockInList?&page=${page + 1}&numPerPage=${rowsPerPage}&supplierId=${id}&payType=${tabStockIn}`, config)
            .then((res) => {
    ...
    const getStockInDataByTab = async (tab) => {
        await axios.get(`${BACKEND_BASE_URL}inventoryrouter/getOwnerStockInList?&page=${1}&numPerPage=${5}&supplierId=${id}&payType=${tab}`, config)
            .then((res) => {
                setStockInData(res.data.rows);
                setTotalRows(res.data.numRows);
            })
    ...
    const getStockInDataByTabByFilter = async (tab) => {
        await axios.get(`${BACKEND_BASE_URL}inventoryrouter/getOwnerStockInList?startDate=${state[0].startDate}&endDate=${state[0].endDate}&page=${1}&numPerPage=${5}&supplierId=${id}&payType=${tab}`, config)
            .then((res) => {
                setStockInData(res.data.rows);
                setTotalRows(res.data.numRows);
            })
    ...
    //     await axios.get(`${BACKEND_BASE_URL}inventoryrouter/getOwnerStockInList?startDate=${state[0].startDate}&endDate=${state[0].endDate}&page=${page + 1}&numPerPage=${rowsPerPage}&supplierId=${id}&payType=${tabStockIn}`, config)
    //         .then((res) => {
    //             setStockInData(res.data.rows);
    //             setTotalRows(res.data.numRows);
    //         })
    ...
    const getStockInDataOnPageChange = async (pageNum, rowPerPageNum) => {
        await axios.get(`${BACKEND_BASE_URL}inventoryrouter/getOwnerStockInList?page=${pageNum}&numPerPage=${rowPerPageNum}&supplierId=${id}&payType=${tabStockIn}`, config)
            .then((res) => {
                setStockInData(res.data.rows);
                setTotalRows(res.data.numRows);
            })
    ...
    const getStockInDataOnPageChangeByFilter = async (pageNum, rowPerPageNum) => {
        await axios.get(`${BACKEND_BASE_URL}inventoryrouter/getOwnerStockInList?startDate=${state[0].startDate}&endDate=${state[0].endDate}&page=${pageNum}&numPerPage=${rowPerPageNum}&supplierId=${id}&payType=${tabStockIn}`, config)
            .then((res) => {
                setStockInData(res.data.rows);
                setTotalRows(res.data.numRows);
            })
    ...
    const getStockInDataByFilter = async () => {
        await axios.get(`${BACKEND_BASE_URL}inventoryrouter/getOwnerStockInList?startDate=${state[0].startDate}&endDate=${state[0].endDate}&page=${1}&numPerPage=${rowsPerPage}&supplierId=${id}&payType=${tabStockIn}`, config)
            .then((res) => {
                setStockInData(res.data.rows);
                setTotalRows(res.data.numRows);
            })
    ...
    const getStatisticsByFilter = async () => {
        await axios.get(`${BACKEND_BASE_URL}inventoryrouter/getOwnerSupplierCounterDetailsById?startDate=${state[0].startDate}&endDate=${state[0].endDate}&supplierId=${id}`, config)
            .then((res) => {
                setStatisticsCounts(res.data);
            })
            .catch((error) => {
    ...
    const getProductCount = async () => {
        await axios.get(`${BACKEND_BASE_URL}inventoryrouter/getOwnerProductDetailsBySupplierId?supplierId=${id}`, config)
            .then((res) => {
    ...
    const getProductCountByFilter = async () => {
        await axios.get(`${BACKEND_BASE_URL}inventoryrouter/getOwnerProductDetailsBySupplierId?startDate=${state[0].startDate}&endDate=${state[0].endDate}&supplierId=${id}`, config)
            .then((res) => {
                setProductQty(res.data);
            })
            .catch((error) => {
    ...
    const getDebitData = async () => {
        await axios.get(`${BACKEND_BASE_URL}inventoryrouter/getOwnerDebitTransactionList?&page=${page + 1}&numPerPage=${rowsPerPage}&supplierId=${id}`, config)
            .then((res) => {
    ...
    const getDebitDataByTab = async () => {
        await axios.get(`${BACKEND_BASE_URL}inventoryrouter/getOwnerDebitTransactionList?&page=${1}&numPerPage=${5}&supplierId=${id}`, config)
            .then((res) => {
                setDebitTransaction(res.data.rows);
                setTotalRowsDebit(res.data.numRows);
            })
    ...
    const getProductDataByTab = async () => {
        await axios.get(`${BACKEND_BASE_URL}inventoryrouter/getOwnerAllProductDetailsBySupplierId?&page=${1}&numPerPage=${5}&supplierId=${id}`, config)
            .then((res) => {
    ...
    const getDebitDataOnPageChange = async (pageNum, rowPerPageNum) => {
        await axios.get(`${BACKEND_BASE_URL}inventoryrouter/getOwnerDebitTransactionList?page=${pageNum}&numPerPage=${rowPerPageNum}&supplierId=${id}`, config)
            .then((res) => {
                setDebitTransaction(res.data.rows);
                setTotalRowsDebit(res.data.numRows);
            })
    ...
    const getProductDataOnPageChange = async (pageNum, rowPerPageNum) => {
        await axios.get(`${BACKEND_BASE_URL}inventoryrouter/getOwnerAllProductDetailsBySupplierId?page=${pageNum}&numPerPage=${rowPerPageNum}&supplierId=${id}`, config)
            .then((res) => {
                setProductTable(res.data.rows);
                setTotalRowsProduct(res.data.numRows);
            })
    ...
    const getDebitDataOnPageChangeByFilter = async (pageNum, rowPerPageNum) => {
        await axios.get(`${BACKEND_BASE_URL}inventoryrouter/getOwnerDebitTransactionList?startDate=${state[0].startDate}&endDate=${state[0].endDate}&page=${pageNum}&numPerPage=${rowPerPageNum}&supplierId=${id}`, config)
            .then((res) => {
                setDebitTransaction(res.data.rows);
                setTotalRowsDebit(res.data.numRows);
            })
    ...
    const getProductDataOnPageChangeByFilter = async (pageNum, rowPerPageNum) => {
        await axios.get(`${BACKEND_BASE_URL}inventoryrouter/getOwnerAllProductDetailsBySupplierId?startDate=${state[0].startDate}&endDate=${state[0].endDate}&page=${pageNum}&numPerPage=${rowPerPageNum}&supplierId=${id}`, config)
            .then((res) => {
                setProductTable(res.data.rows);
                setTotalRowsProduct(res.data.numRows);
            })
    ...
    const getDebitDataByFilter = async () => {
        await axios.get(`${BACKEND_BASE_URL}inventoryrouter/getOwnerDebitTransactionList?startDate=${state[0].startDate}&endDate=${state[0].endDate}&page=${1}&numPerPage=${5}&supplierId=${id}`, config)
            .then((res) => {
                setDebitTransaction(res.data.rows);
                setTotalRowsDebit(res.data.numRows);
            })
    ...
    const getProductDataByFilter = async () => {
        await axios.get(`${BACKEND_BASE_URL}inventoryrouter/getOwnerAllProductDetailsBySupplierId?startDate=${state[0].startDate}&endDate=${state[0].endDate}&page=${1}&numPerPage=${5}&supplierId=${id}`, config)
            .then((res) => {
                setProductTable(res.data.rows);
                setTotalRowsProduct(res.data.numRows);
            })
...
export default SupplierDetailOwner;