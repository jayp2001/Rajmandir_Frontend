...
function ProductListTableStockIn(props) {
    ...
    const [formData, setFormData] = React.useState({
        ...
        productCategoryName: props.name,
        productName: '',
        minProductQty: '',
        minProductUnit: '',
        leadTime: '',
    ...
    const getAllData = async () => {
        await axios.get(`${BACKEND_BASE_URL}inventoryrouter/getProductDetailsTable?productStatus=${tab}&page=${1}&numPerPage=${10}&productCategory=${props.id}`, config)
            .then((res) => {
    ...
    const getAllDataByFilter = async () => {
        await axios.get(`${BACKEND_BASE_URL}inventoryrouter/getProductDetailsTable?startDate=${state[0].startDate}&endDate=${state[0].endDate}&productStatus=${tab}&page=${1}&numPerPage=${10}&searchProduct=${searchWord}&productCategory=${props.id}`, config)
            .then((res) => {
                setAllData(res.data.rows);
                setTotalRows(res.data.numRows)
            })
    ...
    const getCountData = async () => {
        await axios.get(`${BACKEND_BASE_URL}inventoryrouter/getProductListCounter?productCategory=${props.id}`, config)
            .then((res) => {
    ...
    const getAllDataOnPageChange = async (pageNum, rowPerPageNum) => {
        await axios.get(`${BACKEND_BASE_URL}inventoryrouter/getProductDetailsTable?page=${pageNum}&numPerPage=${rowPerPageNum}&productStatus=${tab}&productCategory=${props.id}`, config)
            .then((res) => {
                setAllData(res.data.rows);
                setTotalRows(res.data.numRows);
            })
    ...
    const getAllDataOnPageChangeByFilter = async (pageNum, rowPerPageNum) => {
        await axios.get(`${BACKEND_BASE_URL}inventoryrouter/getProductDetailsTable?startDate=${state[0].startDate}&endDate=${state[0].endDate}&page=${pageNum}&numPerPage=${rowPerPageNum}&productStatus=${tab}&searchProduct=${searchWord}&productCategory=${props.id}`, config)
            .then((res) => {
                setAllData(res.data.rows);
                setTotalRows(res.data.numRows);
            })
    ...
    const search = async (searchWord) => {
        await axios.get(filter ? `${BACKEND_BASE_URL}inventoryrouter/getProductDetailsTable?startDate=${state[0].startDate}&endDate=${state[0].endDate}&productStatus=${tab}&page=${1}&numPerPage=${10}&searchProduct=${searchWord}&productCategory=${props.id}` : `${BACKEND_BASE_URL}inventoryrouter/getProductDetailsTable?productStatus=${tab}&page=${1}&numPerPage=${10}&searchProduct=${searchWord}&productCategory=${props.id}`, config)
            .then((res) => {
                setAllData(res.data.rows);
                setTotalRows(res.data.numRows)
            })
                ...
                <Box sx={style}>
                    ...
                    <div className='mt-6 grid grid-cols-12 gap-6'>
                        ...
                        <div className='col-span-3'>
                            ...
                            <TextField
                                value={formData.productCategoryName ? formData.productCategoryName : ''}
