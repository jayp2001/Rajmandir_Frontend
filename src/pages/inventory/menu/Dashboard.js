...
function MenuDashboard() {
    ...
    const addVariantFields = () => {
        ...
        const newVariant = { unit: unit.unit, price: unit.price, status: true, preferredName: unit.preferredName, preferredNameIsGujarati: unit.preferredNameIsGujarati, index: variantFields.length };
        ...
        if (editData) {
            setEditData(prevState => ({
                ...prevState,
                variantsList: [...prevState.variantsList, { unit: unit.unit, price: unit.price, status: true, preferredName: unit.preferredName, preferredNameIsGujarati: unit.preferredNameIsGujarati }]
            }));
        } else {
                        ...
                        <div className='grid grid-cols-12 gap-4 mt-4'>
                            ...
                            <div className='col-span-3'>
                                {unit.preferredNameIsGujarati ? (
                                    ...
                                    <TextField
                                        ...
                                        className='w-full'
                                        value={unit.preferredName}
                                        error={allFormValidation.preferredName}
                                        helperText={allFormValidation.preferredName ? 'Preferred Name is required' : ''}
                                        onChange={(e) => {
                                            setUnit(prev => ({ ...prev, preferredName: e.target.value }));
                                            setAllFormValidation({ ...allFormValidation, preferredName: false });
                                        }}
                                        autoComplete='off'
                                    />
                            ...
                            <div className='col-span-1 flex flex-col items-center justify-center'>
                                <div className="flex items-center gap-1">
                                    <span className={`text-xs ${!unit.preferredNameIsGujarati ? 'font-bold text-blue-600' : 'text-gray-400'}`}>ENG</span>
                                    <Switch
                                        checked={unit.preferredNameIsGujarati}
                                        onChange={(e) => setUnit(prev => ({ ...prev, preferredNameIsGujarati: e.target.checked }))}
                                        size="small"
                                    />
                                    <span className={`text-xs ${unit.preferredNameIsGujarati ? 'font-bold text-blue-600' : 'text-gray-400'}`}>ગુજ</span>
                                </div>
                            </div>
                            <div className='col-span-2'>
                                <TextField
                                ...
                                <div style={{
                                    ...
                                    <div
                                        ...
                                        style={{
                                            ...
                                            display: 'grid',
                                            gridTemplateColumns: '40px 1.5fr 2.5fr 1fr 1.5fr 1.5fr',
                                            columnGap: '12px',
                                            alignItems: 'center',
                                            zIndex: 10,
