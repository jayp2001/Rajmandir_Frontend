...
function EditSuppilerInOutNpayment() {
    let { id } = useParams();
    ...
    const getData = async () => {
        await axios.get(`${BACKEND_BASE_URL}inventoryrouter/ddlAllProductData`, config)
            .then(async (response) => {
    ...
    const reset = () => {
        navigate(`/InOutNpayment/suppilerTable`)
    }
...
export default EditSuppilerInOutNpayment;