...
function SupplierTableInOutNpayment() {
    ...
    const handleSupplierOnClick = (id) => {
        navigate(`/InOutNpayment/supplierDetails/${id}`)
    }
                    ...
                    <div className='userTableSubContainer'>
                        ...
                        <div className='grid grid-cols-12'>
                            ...
                            <div className='col-span-4 col-start-9 pr-8 flex justify-end'>
                                <button className='exportExcelBtn' onClick={() => { navigate(`/InOutNpayment/addSupplier`) }}>Add Supplier</button>
                            </div>
                        </div>
                                            ...
                                            totalRows !== 0 ?
                                                ...
                                                >
                                                    ...
                                                    <TableCell align="right">
                                                        <Menutemp supplierId={row.supplierId} handleOpen={handleOpen} data={row} deleteSupplier={handleDeleteSupplier} />
                                                    </TableCell>
                                                </TableRow> :
                                                <TableRow
                                                    key={row.userId}
...
export default SupplierTableInOutNpayment;