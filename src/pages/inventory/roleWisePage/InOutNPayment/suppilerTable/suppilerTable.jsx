...
function SuppilerTableInOutNpayment() {
    ...
    const handleSuppilerOnClick = (id) => {
        navigate(`/InOutNpayment/suppilerDetails/${id}`)
    }
                    ...
                    <div className='userTableSubContainer'>
                        ...
                        <div className='grid grid-cols-12'>
                            ...
                            <div className='col-span-4 col-start-9 pr-8 flex justify-end'>
                                <button className='exportExcelBtn' onClick={() => { navigate(`/InOutNpayment/addSuppiler`) }}>Add Suppiler</button>
                            </div>
                        </div>
...
export default SuppilerTableInOutNpayment;