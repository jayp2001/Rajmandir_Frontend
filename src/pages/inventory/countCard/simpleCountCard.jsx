...
function SimpleCountCard(props) {
    const getImg = (imgname) => {
        ...
        const normalizedName = imgname ? imgname.trim() : '';

        // Create a case-insensitive lookup map for fallback
        const iconMap = {
            'pickup summary': <StorefrontIcon fontSize='large' />,
            'delivery summary': <DeliveryDiningIcon fontSize='large' />,
            'dinein summary': <RestaurantIcon fontSize='large' />,
            'cash summary': <LocalAtmIcon fontSize='large' />,
            'due summary': <AccountBalanceWalletIcon fontSize='large' />,
            'online summary': <CreditCardIcon fontSize='large' />,
            'complimentary summary': <RedeemIcon fontSize='large' />,
            'cancel summary': <CancelIcon fontSize='large' />,
            'total discount': <DiscountIcon fontSize='large' />,
            'visit': <PeopleIcon fontSize='large' />,
            'average visit per month': <CalendarMonthIcon fontSize='large' />,
            'average business per year': <TrendingUpIcon fontSize='large' />,
        };
        ...
        switch (normalizedName) {
            ...
            default:
                ...
                // If still no match, return default icon
