...
function FactorySuppilerTable() {
    ...
    const handleSuppilerOnClick = (id) => {
        navigate(`/material/suppilerDetails/${id}`)
    }
                    ...
                    <div className='userTableSubContainer'>
                        ...
                        <div className='grid grid-cols-12'>
                            ...
                            <div className='col-span-4 col-start-9 pr-8 flex justify-end'>
                                <button className='exportExcelBtn' onClick={() => { navigate(`/material/addSuppiler`) }}>Add Suppiler</button>
                            </div>
                        </div>
...
export default FactorySuppilerTable;