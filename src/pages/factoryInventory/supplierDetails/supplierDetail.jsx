...
function FactorySupplierDetail() {
    let { id } = useParams();
    ...
    const getSupplierDetails = async () => {
        await axios.get(`${BACKEND_BASE_URL}rawMaterialrouter/getFactorySupplierDetailsById?rmSupplierId=${id}`, config)
            .then((res) => {
    ...
    const getStatistics = async () => {
        await axios.get(`${BACKEND_BASE_URL}rawMaterialrouter/getFactorySupplierCounterDetailsById?rmSupplierId=${id}`, config)
            .then((res) => {
    ...
    const getStockInData = async () => {
        await axios.get(`${BACKEND_BASE_URL}rawMaterialrouter/getRawMaterialStockInList?&page=${page + 1}&numPerPage=${rowsPerPage}&rmSupplierId=${id}&payType=${tabStockIn}`, config)
            .then((res) => {
    ...
    const getStockInDataByTab = async (tab) => {
        await axios.get(`${BACKEND_BASE_URL}rawMaterialrouter/getRawMaterialStockInList?&page=${1}&numPerPage=${5}&rmSupplierId=${id}&payType=${tab}`, config)
            .then((res) => {
                setStockInData(res.data.rows);
                setTotalRows(res.data.numRows);
            })
    ...
    const getStockInDataByTabByFilter = async (tab) => {
        await axios.get(`${BACKEND_BASE_URL}rawMaterialrouter/getRawMaterialStockInList?startDate=${state[0].startDate}&endDate=${state[0].endDate}&page=${1}&numPerPage=${5}&rmSupplierId=${id}&payType=${tab}`, config)
            .then((res) => {
                setStockInData(res.data.rows);
                setTotalRows(res.data.numRows);
            })
    ...
    //     await axios.get(`${BACKEND_BASE_URL}rawMaterialrouter/getRawMaterialStockInList?startDate=${state[0].startDate}&endDate=${state[0].endDate}&page=${page + 1}&numPerPage=${rowsPerPage}&rmSupplierId=${id}&payType=${tabStockIn}`, config)
    //         .then((res) => {
    //             setStockInData(res.data.rows);
    //             setTotalRows(res.data.numRows);
    //         })
    ...
    const getStockInDataOnPageChange = async (pageNum, rowPerPageNum) => {
        await axios.get(`${BACKEND_BASE_URL}rawMaterialrouter/getRawMaterialStockInList?page=${pageNum}&numPerPage=${rowPerPageNum}&rmSupplierId=${id}&payType=${tabStockIn}`, config)
            .then((res) => {
                setStockInData(res.data.rows);
                setTotalRows(res.data.numRows);
            })
    ...
    const getStockInDataOnPageChangeByFilter = async (pageNum, rowPerPageNum) => {
        await axios.get(`${BACKEND_BASE_URL}rawMaterialrouter/getRawMaterialStockInList?startDate=${state[0].startDate}&endDate=${state[0].endDate}&page=${pageNum}&numPerPage=${rowPerPageNum}&rmSupplierId=${id}&payType=${tabStockIn}`, config)
            .then((res) => {
                setStockInData(res.data.rows);
                setTotalRows(res.data.numRows);
            })
    ...
    const getStockInDataByFilter = async () => {
        await axios.get(`${BACKEND_BASE_URL}rawMaterialrouter/getRawMaterialStockInList?startDate=${state[0].startDate}&endDate=${state[0].endDate}&page=${1}&numPerPage=${rowsPerPage}&rmSupplierId=${id}&payType=${tabStockIn}`, config)
            .then((res) => {
                setStockInData(res.data.rows);
                setTotalRows(res.data.numRows);
            })
    ...
    const getStatisticsByFilter = async () => {
        await axios.get(`${BACKEND_BASE_URL}rawMaterialrouter/getFactorySupplierCounterDetailsById?startDate=${state[0].startDate}&endDate=${state[0].endDate}&rmSupplierId=${id}`, config)
            .then((res) => {
                setStatisticsCounts(res.data);
            })
            .catch((error) => {
    ...
    const getProductCount = async () => {
        await axios.get(`${BACKEND_BASE_URL}rawMaterialrouter/getRawMaterialsBySupplierId?rmSupplierId=${id}`, config)
            .then((res) => {
    ...
    const getProductCountByFilter = async () => {
        await axios.get(`${BACKEND_BASE_URL}rawMaterialrouter/getRawMaterialsBySupplierId?startDate=${state[0].startDate}&endDate=${state[0].endDate}&rmSupplierId=${id}`, config)
            .then((res) => {
                setProductQty(res.data);
            })
            .catch((error) => {
    ...
    const getDebitData = async () => {
        await axios.get(`${BACKEND_BASE_URL}rawMaterialrouter/getRmDebitTransactionList?&page=${page + 1}&numPerPage=${rowsPerPage}&rmSupplierId=${id}`, config)
            .then((res) => {
    ...
    const getDebitDataByTab = async () => {
        await axios.get(`${BACKEND_BASE_URL}rawMaterialrouter/getRmDebitTransactionList?&page=${1}&numPerPage=${5}&rmSupplierId=${id}`, config)
            .then((res) => {
                setDebitTransaction(res.data.rows);
                setTotalRowsDebit(res.data.numRows);
            })
    ...
    const getProductDataByTab = async () => {
        await axios.get(`${BACKEND_BASE_URL}rawMaterialrouter/getAllRawMaterialsBySupplierId?&page=${1}&numPerPage=${5}&rmSupplierId=${id}`, config)
            .then((res) => {
    ...
    const getDebitDataOnPageChange = async (pageNum, rowPerPageNum) => {
        await axios.get(`${BACKEND_BASE_URL}rawMaterialrouter/getRmDebitTransactionList?page=${pageNum}&numPerPage=${rowPerPageNum}&rmSupplierId=${id}`, config)
            .then((res) => {
                setDebitTransaction(res.data.rows);
                setTotalRowsDebit(res.data.numRows);
            })
    ...
    const getProductDataOnPageChange = async (pageNum, rowPerPageNum) => {
        await axios.get(`${BACKEND_BASE_URL}rawMaterialrouter/getAllRawMaterialsBySupplierId?page=${pageNum}&numPerPage=${rowPerPageNum}&rmSupplierId=${id}`, config)
            .then((res) => {
                setProductTable(res.data.rows);
                setTotalRowsProduct(res.data.numRows);
            })
    ...
    const getDebitDataOnPageChangeByFilter = async (pageNum, rowPerPageNum) => {
        await axios.get(`${BACKEND_BASE_URL}rawMaterialrouter/getRmDebitTransactionList?startDate=${state[0].startDate}&endDate=${state[0].endDate}&page=${pageNum}&numPerPage=${rowPerPageNum}&rmSupplierId=${id}`, config)
            .then((res) => {
                setDebitTransaction(res.data.rows);
                setTotalRowsDebit(res.data.numRows);
            })
    ...
    const getProductDataOnPageChangeByFilter = async (pageNum, rowPerPageNum) => {
        await axios.get(`${BACKEND_BASE_URL}rawMaterialrouter/getAllRawMaterialsBySupplierId?startDate=${state[0].startDate}&endDate=${state[0].endDate}&page=${pageNum}&numPerPage=${rowPerPageNum}&rmSupplierId=${id}`, config)
            .then((res) => {
                setProductTable(res.data.rows);
                setTotalRowsProduct(res.data.numRows);
            })
    ...
    const getDebitDataByFilter = async () => {
        await axios.get(`${BACKEND_BASE_URL}rawMaterialrouter/getRmDebitTransactionList?startDate=${state[0].startDate}&endDate=${state[0].endDate}&page=${1}&numPerPage=${5}&rmSupplierId=${id}`, config)
            .then((res) => {
                setDebitTransaction(res.data.rows);
                setTotalRowsDebit(res.data.numRows);
            })
    ...
    const getProductDataByFilter = async () => {
        await axios.get(`${BACKEND_BASE_URL}rawMaterialrouter/getAllRawMaterialsBySupplierId?startDate=${state[0].startDate}&endDate=${state[0].endDate}&page=${1}&numPerPage=${5}&rmSupplierId=${id}`, config)
            .then((res) => {
                setProductTable(res.data.rows);
                setTotalRowsProduct(res.data.numRows);
            })
    ...
    const makePayment = async () => {
        setLoading(true)
        await axios.post(`${BACKEND_BASE_URL}rawMaterialrouter/addFacttorySupplierTransactionDetails`, formData, config)
            .then((res) => {
                setSuccess(true)
                setLoading(false)
                setFormData((perv) => ({
    ...
    const deleteData = async (id) => {
        await axios.delete(`${BACKEND_BASE_URL}rawMaterialrouter/removeFactorySupplierTransactionDetails?supplierTransactionId=${id}`, config)
            .then((res) => {
                getStatistics();
                setSuccess(true)
                getDebitData();
    ...
    const getInvoice = async (tId, supplierName) => {
        if (window.confirm('Are you sure you want to Download Invoice ... ?')) {
            await axios({
                url: `${BACKEND_BASE_URL}rawMaterialrouter/exportRmSupplierTransactionInvoiceData?transactionId=${tId}`,
                method: 'GET',
    ...
    const stockInExportExcel = async () => {
        if (window.confirm('Are you sure you want to export Excel ... ?')) {
            await axios({
                url: filter ? `${BACKEND_BASE_URL}rawMaterialrouter/exportExcelSheetForRawMaterialStockInList?startDate=${state[0].startDate}&endDate=${state[0].endDate}&rmSupplierId=${id}&payType=${tabStockIn}` : `${BACKEND_BASE_URL}rawMaterialrouter/exportExcelSheetForRawMaterialStockInList?startDate=${''}&endDate=${''}&rmSupplierId=${id}&payType=${tabStockIn}`,
                method: 'GET',
                headers: { Authorization: `Bearer ${userInfo.token}` },
                responseType: 'blob', // important
            }).then((response) => {
    ...
    const stockInExportPdf = async () => {
        if (window.confirm('Are you sure you want to export Pdf ... ?')) {
            await axios({
                url: filter ? `${BACKEND_BASE_URL}rawMaterialrouter/exportPdfForRawMaterialStockInList?startDate=${state[0].startDate}&endDate=${state[0].endDate}&rmSupplierId=${id}&payType=${tabStockIn}` : `${BACKEND_BASE_URL}rawMaterialrouter/exportPdfForRawMaterialStockInList?startDate=${''}&endDate=${''}&rmSupplierId=${id}&payType=${tabStockIn}`,
                method: 'GET',
                headers: { Authorization: `Bearer ${userInfo.token}` },
                responseType: 'blob', // important
            }).then((response) => {
    ...
    const allProductExportPdf = async () => {
        if (window.confirm('Are you sure you want to export Pdf ... ?')) {
            await axios({
                url: filter ? `${BACKEND_BASE_URL}rawMaterialrouter/exportPdfForAllRawMaterialsBySupplierId?startDate=${state[0].startDate}&endDate=${state[0].endDate}&rmSupplierId=${id}&payType=${tabStockIn}` : `${BACKEND_BASE_URL}rawMaterialrouter/exportPdfForAllRawMaterialsBySupplierId?startDate=${''}&endDate=${''}&rmSupplierId=${id}&payType=${tabStockIn}`,
                method: 'GET',
                headers: { Authorization: `Bearer ${userInfo.token}` },
                responseType: 'blob', // important
            }).then((response) => {
    ...
    const transactionExportPdf = async () => {
        if (window.confirm('Are you sure you want to export Pdf ... ?')) {
            await axios({
                url: filter ? `${BACKEND_BASE_URL}rawMaterialrouter/exportPdfForRmDebitTransactionList?startDate=${state[0].startDate}&endDate=${state[0].endDate}&rmSupplierId=${id}` : `${BACKEND_BASE_URL}rawMaterialrouter/exportPdfForRmDebitTransactionList?startDate=${''}&endDate=${''}&rmSupplierId=${id}`,
                method: 'GET',
                headers: { Authorization: `Bearer ${userInfo.token}` },
                responseType: 'blob', // important
            }).then((response) => {
    ...
    const allProductExportExcel = async () => {
        if (window.confirm('Are you sure you want to export Excel ... ?')) {
            await axios({
                url: filter ? `${BACKEND_BASE_URL}rawMaterialrouter/exportExcelSheetForAllRawMaterialsBySupplierId?startDate=${state[0].startDate}&endDate=${state[0].endDate}&rmSupplierId=${id}&payType=${tabStockIn}` : `${BACKEND_BASE_URL}rawMaterialrouter/exportExcelSheetForAllRawMaterialsBySupplierId?startDate=${''}&endDate=${''}&rmSupplierId=${id}&payType=${tabStockIn}`,
                method: 'GET',
                headers: { Authorization: `Bearer ${userInfo.token}` },
                responseType: 'blob', // important
            }).then((response) => {
    ...
    const transactionExportExcel = async () => {
        if (window.confirm('Are you sure you want to export Excel ... ?')) {
            await axios({
                url: filter ? `${BACKEND_BASE_URL}rawMaterialrouter/exportExcelSheetForRmDebitTransactionList?startDate=${state[0].startDate}&endDate=${state[0].endDate}&rmSupplierId=${id}` : `${BACKEND_BASE_URL}rawMaterialrouter/exportExcelSheetForRmDebitTransactionList?startDate=${''}&endDate=${''}&rmSupplierId=${id}`,
                method: 'GET',
                headers: { Authorization: `Bearer ${userInfo.token}` },
                responseType: 'blob', // important
            }).then((response) => {
                            ...
                            <div className='grid grid-cols-1 gap-6 pb-3'>
                                {
                                    productQtyCount && productQtyCount?.map((row, index) => (
                                        <ProductQtyCountCard minRawMaterialUnit={row.minRawMaterialUnit} rawMaterialPrice={row.rawMaterialPrice} rawMaterialQty={row.remainingStock} rawMaterialName={row.rawMaterialName} index={index} />
                                    ))
                                }
                            </div>
                        </div>
                                        ...
                                        {stockInData?.map((row, index) => (
                                            totalRows !== 0 ?
                                                ...
                                                >
                                                    ...
                                                    <TableCell align="right" >{parseFloat(row.rawMaterialPrice ? row.rawMaterialPrice : 0).toLocaleString('en-IN')}</TableCell>
                                                    ...
                                                    <TableCell align="right">
                                                        <MenuStockInOut stockInOutId={row.rmStockInId} data={row} deleteStockInOut={handleDeleteStockIn} setError={setError} />
                                                    </TableCell>
                                                </TableRow> :
                                                <TableRow
                                                    key={row.userId}
...
export default FactorySupplierDetail;