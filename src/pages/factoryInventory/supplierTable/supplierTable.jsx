...
function FactorySupplierTable() {
    ...
    const handleSupplierOnClick = (id) => {
        navigate(`/material/supplierDetails/${id}`)
    }
                    ...
                    <div className='userTableSubContainer'>
                        ...
                        <div className='grid grid-cols-12'>
                            ...
                            <div className='col-span-4 col-start-9 pr-8 flex justify-end'>
                                <button className='exportExcelBtn' onClick={() => { navigate(`/material/addSupplier`) }}>Add Supplier</button>
                            </div>
                        </div>
...
export default FactorySupplierTable;