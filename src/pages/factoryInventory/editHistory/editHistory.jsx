...
function EditHistoryMaterial() {
    ...
    const getData = async () => {
        ...
        await axios.get(`${BACKEND_BASE_URL}rawMaterialrouter/getUpdateRmStockOutListById?page=${1}&numPerPage=${5}&rmStockOutId=${id}`, config)
            .then((res) => {
    ...
    const getDataOnPageChange = async (pageNum, rowPerPageNum) => {
        console.log("page get", page, rowsPerPage)
        await axios.get(`${BACKEND_BASE_URL}rawMaterialrouter/getUpdateRmStockOutListById?page=${pageNum}&numPerPage=${rowPerPageNum}&rmStockOutId=${id}`, config)
            .then((res) => {
                setData(res.data.rows);
                setTotalRows(res.data.numRows);
            })
    ...
    const deleteData = async () => {
        if (window.confirm('Are you sure you want to delete all edit history ....!')) {
            await axios.delete(`${BACKEND_BASE_URL}rawMaterialrouter/emptyModifiedHistoryOfRmStockOutById?rmStockOutId=${id}`, config)
                .then((res) => {
                    setPage(0);
                    setSuccess(true)
                    setRowsPerPage(5);
...
export default EditHistoryMaterial;
